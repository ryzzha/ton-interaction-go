...
func run() error {
	...
	words := strings.Split("air blouse morning grant load across rose panther bitter tumble grape craft foam parent unlock marine inner cannon mutual teach cost renew just vague", " ")
